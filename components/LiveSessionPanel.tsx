    ...
    return (
      <div className="flex flex-col gap-3.5 p-5 h-full overflow-y-auto">
        ...
        <div className="bg-muted/40 border border-border rounded-xl px-5 py-4 text-center relative overflow-hidden">
          ...
          <p className="text-[10px] font-bold uppercase tracking-wider text-text-secondary mb-2 [:fullscreen_&]:text-base">Total charging time</p>
          <p className="text-5xl font-bold tabular-nums leading-none mb-4 [:fullscreen_&]:text-9xl text-foreground">{fmtTimer(ls.durationMins * 60)}</p>
        ...
        <div className="grid grid-cols-6 gap-2">
          <div className="col-span-3 bg-muted/40 border border-border rounded-xl p-5 relative overflow-hidden">
            ...
            <div className="flex items-start gap-4 [:fullscreen_&]:gap-10">
              <span className="text-3xl font-bold tabular-nums leading-none [:fullscreen_&]:text-6xl">
                {ls.startSoc}<span className="text-xs font-normal text-text-secondary [:fullscreen_&]:text-lg">%</span>
              </span>
              ...
              <span className="text-3xl font-bold tabular-nums leading-none [:fullscreen_&]:text-6xl">
                {ls.endSoc}<span className="text-xs font-normal text-text-secondary [:fullscreen_&]:text-lg">%</span>
              </span>
            </div>
          </div>
          <div className="col-span-3 bg-muted/40 border border-border rounded-xl p-5 relative overflow-hidden">
            ...
            <span className="text-3xl font-bold tabular-nums leading-none [:fullscreen_&]:text-6xl text-text-secondary">–</span>
          </div>
          <div className="col-span-2 bg-muted/40 border border-border rounded-xl p-5 relative overflow-hidden">
            ...
            <span className="text-2xl font-bold tabular-nums leading-none [:fullscreen_&]:text-5xl">
              {ls.energySoldKwh}<span className="text-xs font-normal text-text-secondary ml-1 [:fullscreen_&]:text-lg">kWh</span>
            </span>
          </div>
          <div className="col-span-2 bg-muted/40 border border-border rounded-xl p-5 relative overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-[2px] opacity-20" style={{ background: 'linear-gradient(to right, #888, transparent)' }} />
            ...
            <span className="text-2xl font-bold tabular-nums leading-none [:fullscreen_&]:text-5xl">₹{lsRevenue}</span>
          </div>
          <div className="col-span-2 bg-muted/40 border border-border rounded-xl p-5 relative overflow-hidden">
            <div className="absolute top-0 left-0 right-0 h-[2px] opacity-20" style={{ background: 'linear-gradient(to right, #888, transparent)' }} />
